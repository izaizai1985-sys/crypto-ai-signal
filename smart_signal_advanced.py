...
# =======================
# Exchanges list (multiple sources)
# =======================
EXCHANGES = []
for ex in ['binance', 'kraken', 'kucoin', 'gateio']:
    try:
        EXCHANGES.append(getattr(ccxt, ex)({'enableRateLimit': True}))
    except Exception as e:
        print(f"{ex} init error: {e}")
...
def analyze(symbol):
    for exchange in EXCHANGES:
        try:
            ...
            if score < SCORE_THRESHOLD or trend is None: return None
